...
selected_year =st.sidebar.selectbox('Year',list (reversed(range(2015,2020))))
...
def filedownload(df):
    ...
    href =f'<a href="data:file/csv;base64,{b64}"download="playerstats.csv">Download the CSV File</a>'
    return href
